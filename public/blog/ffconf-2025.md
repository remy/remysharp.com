...
summary: Reflections on FFConf 2025, covering talks on diversity, data privacy, web components, AI, and the future of the web.
---
...
The videos of the talks will be released in the coming weeks and [our newsletter](https://ffconf.org/news) will highlight each in turn.

I curated the talks so that up front we had the heavier subjects: diversity from [Hellen](https://2025.ffconf.org/hellen) and data privacy from [Chetan](https://2025.ffconf.org/chetan).
...
The next segment talked about web components from [Hannah](https://2025.ffconf.org/hannah) and about cults from [Sèrges](https://2025.ffconf.org/serges).
...
The two talks were very different perspectives on AI. [Asim](https://2025.ffconf.org/asim) gave a talk (obscurely but made sense in the end) entitled Don't be an Idiot on how AI can, and is, being used to democratise big decisions, putting much more nuance in the decisions offered to people.

The following was [Jess and Eda](https://2025.ffconf.org/jessica-eda) on AI coding tools and skills. Told from the perspective of a senior and junior and what are the lasting impacts on relying (or being pushed into) AI tools. Very much the argument of shallow learning versus deep (human) learning through experience.

Finally to close the event two talks from the vast spread of experience starting with [Surya](https://2025.ffconf.org/surya) on the journey of 6 to 16 years old and coding. As our industry continues to exist, it's the young people who will breathe life into it, so I wanted to hear about Surya's experience (even if he is a bit of a black swan - making many of us old hats feel rather like underachievers!).
...
So the (first) one thing I decided to do, relatively simple, was to move to more paid services (I've switched to [Kagi](https://kagi.com/) already). I've already started paying for my news ([404 Media](https://www.404media.co/), [Novara Media](https://novaramedia.com/), Guardian and a few others) so I'm continuing to look for these. I also know that this works if you have the funds. For me, it's part of my work, so my business pays for it. I get that it's not as simple for others (that's to say: this is *my* one thing!).
...
I'll be attending more events myself next year too, including [State of the Browser](https://2026.stateofthebrowser.com/), [Web Day Out](https://webdayout.com/), (the final) [All Day Hey](https://heypresents.com/conferences/2026), [Beyond Tellerand](https://beyondtellerrand.com/events/dusseldorf-2026) and [WDC](https://webdevconf.com/events/) (tickets aren't live yet). I'm on the lookout for more events and meet ups in particular (though I have a stinking record of staying at home).
